...
$cosme_post_navigation_enable 	= 	get_theme_mod('cosme_single_post_navigation_enable', 1);
$cosme_comment_box_enable		= 	get_theme_mod('cosme_single_comment_box_enable', 1);
					...
					<main id="main" class="site-main">
						...
						<?php
							while ( have_posts() ) :
								...
								if($cosme_post_navigation_enable):
									the_post_navigation(
										array(
