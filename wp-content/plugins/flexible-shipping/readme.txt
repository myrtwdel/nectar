...
* Fixed fatal error on order creation via REST API
...
= 4.25.6 - 2024-08-20 =
* Fixed RTL styles in advertising box
...
= 4.25.2 - 2024-07-01 =
* Fixed PRO version advertisement
* Fixed bulk label generation error handling
